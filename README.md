...
The extension pins `oilpriceapi-mcp@3.3.0`, starts it with `--scope read`, and
...
```bash
npx -y oilpriceapi-mcp@3.3.0 --list-tools --json
npx -y oilpriceapi-mcp@3.3.0 --capabilities --json
npx -y oilpriceapi-mcp@3.3.0 doctor --demo
```
